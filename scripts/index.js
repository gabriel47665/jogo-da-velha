...
function checkWinner() {
  ...
  if (
    ...
    elements[0].style = "background-color: grey";
    elements[1].style = "background-color: grey";
    elements[2].style = "background-color: grey";
    return true;
  }
  if (
    ...
    elements[3].style = "background-color: grey";
    elements[4].style = "background-color: grey";
    elements[5].style = "background-color: grey";
    return true;
  }
  if (
    ...
    elements[6].style = "background-color: grey";
    elements[7].style = "background-color: grey";
    elements[8].style = "background-color: grey";
    return true;
  }
  if (
